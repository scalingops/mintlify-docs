...
<Steps>
  ...
  <Step title="Enable Contracts Sync">
    Contracts (called Agreements in ConnectWise) provide the recurring revenue and managed service agreement data. Enable contracts sync in your PSA integration settings.
  </Step>
</Steps>
