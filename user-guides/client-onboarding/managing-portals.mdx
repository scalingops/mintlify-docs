...
<Note>
PSA integration works with Halo PSA, ConnectWise Manage, Autotask, and Syncro. The portal must be linked to a PSA project before you can create tickets or log time.
</Note>
