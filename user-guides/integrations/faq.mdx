...
<Steps>
  ...
  <Step title="Select Queues to Sync">
    ...
    - **ConnectWise**: Select Service Boards in [Ticket Settings](/user-guides/integrations/connectwise-configure-and-service-desk)
...
|-----------|----------------|-------|
| **Tickets** | Every 30 minutes | Incremental sync of recent changes |
...
Changes made in your PSA will appear in MSPortal after the next scheduled sync (typically within 30 minutes).

If you need the changes immediately:

<CardGroup cols={2}>
  <Card title="Wait for Auto-Sync" icon="clock">
    Most data syncs every 30 minutes automatically. Simply wait for the next sync cycle.
  </Card>
