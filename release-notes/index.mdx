...
### Meeting Private Notes

Meetings now include a **Private Notes** field that persists across sessions. Private notes are saved alongside your meeting content and appear in all calendar views (list, recurring, and detail). Previously, private notes were visible in the UI but were not saved to the database.
