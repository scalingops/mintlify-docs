...
**Project Detail View:**
- **Overview Tab**: Project summary with contacts, dates, budget status, and AI-generated summary
...
- **Updates Tab**: Weekly status updates with internal notes
...
- **AI Summaries**: Generate project summaries with one click using AI
