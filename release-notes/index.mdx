...
Additionally, if you are using the [recommended custom role](/user-guides/integrations/Halo%20PSA%20Custom%20Role%20and%20User), ensure the **Invoices** access level is set to **Read, Create, Modify and Delete**.
